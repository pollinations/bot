...
// const { combine, timestamp, printf, colorize, json, errors, prettyPrint, metadata } = winston.format;
...
// const humanReadable = printf(({ level, message, timestamp, error }) => {
//   const primer = `${timestamp} ${level}: ${message}`;
//   const errorMsg = error ? `\n${error.stack}` : '';

//   return `${primer}${errorMsg}`;
// });
